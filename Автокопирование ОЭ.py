...
while True:
    ...
    if a == "3608":
        src = "C:\\Users\\rgilin\\Desktop\\Шаблоны\\3608 ОЭ"
        ...
        if f == 'Д' or f == 'д':
            ...
            print("Копирование файлов...", end='\r')
            copytree(src, dst2)
    ...
    if a == "2458":
        src = "C:\\Users\\rgilin\\Desktop\\Шаблоны\\2458 ОЭ"
        print("Выбрана сеть: " + a)
        print("Путь к папке с шаблонами: " + src)
        f = input("Подтверждаете? (Д/Н) ")
        if f == 'Д' or f == 'д':
    ...
    if a == "3189":
        src = "C:\\Users\\rgilin\\Desktop\\Шаблоны\\3189 ОЭ"
        print("Выбрана сеть: " + a)
        print("Путь к папке с шаблонами: " + src)
        f = input("Подтверждаете? (Д/Н) ")
        if f == 'Д' or f == 'д':
